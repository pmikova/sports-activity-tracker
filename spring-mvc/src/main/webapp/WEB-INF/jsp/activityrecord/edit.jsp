...
<own:pagetemplate title="Settings">
    ...
    <jsp:attribute name="body">
            ...
            <a href="${pageContext.request.contextPath}/records/detail/${id}" class="btn btn-default" role="button">
            ...
            <form:form method="POST"
                       action="${pageContext.request.contextPath}/records/detail/${id}"
                       acceptCharset=""
                    ...
                    <div class="col-sm-10">
                      ...
                      <div class="form-group ${distance_error?'has-error':''}">
                          <form:label path="distance" cssClass="col-sm-2 control-label">
                              <fmt:message key="record.distance"/>
                          </form:label>
                          <div class="col-sm-10">
